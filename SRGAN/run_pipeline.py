...
if __name__ == "__main__":
    ...
    train_ds = catesr_train.dataset(batch_size=2, random_transform=True, shuffle_buffer_size=500)
    valid_ds = catesr_valid.dataset(batch_size=2, random_transform=True, shuffle_buffer_size=500)
